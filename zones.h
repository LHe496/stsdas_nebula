...
define	Z_ATL		Memi[P2I($1+0)]	# Atomic data object list
...
define	Te_Nii		Memr[P2R($1+9)]	# Temperature for low ionization region
define	Te_Oii		Memr[P2R($1+10)]	# Temperature for low ionization region
define	Te_Oiii		Memr[P2R($1+11)]	# Temperature for med ionization region
define	Te_NEiii	Memr[P2R($1+12)]	# Temperature for med ionization region
#define	Te_NEiv		Memr[P2R($1+13)]	# Temperature for high ionization region
define	Te_NEv		Memr[P2R($1+14)]	# Temperature for high ionization region
define	Te_Sii		Memr[P2R($1+15)]	# Temperature for low ionization region
define	Te_Siii		Memr[P2R($1+16)]	# Temperature for med ionization region
define	Te_ARiii	Memr[P2R($1+17)]	# Temperature for med ionization region
define	Te_ARiv		Memr[P2R($1+18)]	# Temperature for med ionization region
define	Te_ARv		Memr[P2R($1+19)]	# Temperature for high ionization region
...
define	Te_Low		Memr[P2R($1+23)]	# Temperature for low ionization region
define	Te_Med		Memr[P2R($1+24)]	# Temp. for medium ionization region
define	Te_Hi		Memr[P2R($1+25)]	# Temperature for high ionization region
